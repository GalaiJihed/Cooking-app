...
export default class StepsIndicator extends Component {
    ...
    render() {
        return (
            <Swiper  style={styles.wrapper} onIndexChanged={(index)=>{index===5?setTimeout(() => this.props.navigation.navigate('ClientsScreen'), 5000):console.log("no")}} loop={false} dot={<View style={{backgroundColor:'rgba(0,0,0,.2)', width: 8, height: 8,borderRadius: 4, marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3,}} />} showsButtons={false}>
